                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="session-ex-header">
                          <div className="session-ex-top">
                            <div className="session-ex-name">{w.exercise}</div>
                            {!isEditing && !linkingMode && (
                              <div className="session-ex-btns">
                                <button className="session-icon-btn" title="View progress" onClick={() => setHistoryExercise(w.exercise)}>
                                  <svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
                                </button>
                                <button className="session-icon-btn" title="Edit" onClick={() => startEdit(w)}>
                                ...
                                <button className="session-icon-btn session-icon-delete" title="Delete" onClick={() => remove(w.id)}>
