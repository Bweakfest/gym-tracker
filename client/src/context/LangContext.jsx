...
const translations = {
  en: {
    ...
    topLifts: 'Top Lifts',
    yourJourney: 'Your training journey at a glance',
    prs: 'PRs',
    reset: 'Reset',
    pause: 'Pause',
    done: 'Done',
    restIsUp: 'Rest is up — back to work!',
    nextSet: 'Time for your next set.',
  ...
  de: {
    ...
    sessionCoach: 'Einheits-Coach',
    volumeByMuscle: 'Volumen nach Muskelgruppe',
    scanBarcode: 'Barcode scannen',
    todaysFoodLog: 'Heutiges Essensprotokoll',
    ...
    gymSessions: 'Trainingseinheiten',
    topLifts: 'Top-Übungen',
    yourJourney: 'Dein Trainingsweg auf einen Blick',
    prs: 'PRs',
    reset: 'Zurücksetzen',
    pause: 'Pause',
    done: 'Fertig',
    restIsUp: 'Pause vorbei — weiter geht\'s!',
    nextSet: 'Zeit für deinen nächsten Satz.',
    clearChatConfirm: 'Chatverlauf löschen?',
    weeklyRecap: 'Wochenrückblick',
    progressAnalyzer: 'Fortschrittsanalyse',
    chat: 'Chat',
  },
  fr: {
    ...
    sessionCoach: 'Coach de s\u00e9ance',
    volumeByMuscle: 'Volume par groupe musculaire',
    scanBarcode: 'Scanner code-barres',
    todaysFoodLog: 'Journal alimentaire du jour',
    ...
    loadDay: 'Charger le jour',
    createRoutine: 'Cr\u00e9er routine',
    memberSince: 'Membre depuis',
    gymSessions: 's\u00e9ances',
    topLifts: 'Meilleurs exercices',
    yourJourney: 'Votre parcours d\'entra\u00eenement en un coup d\'\u0153il',
    prs: 'PRs',
    reset: 'R\u00e9initialiser',
    pause: 'Pause',
    done: 'Termin\u00e9',
    restIsUp: 'Repos termin\u00e9 \u2014 au travail !',
    nextSet: 'C\'est l\'heure de votre prochaine s\u00e9rie.',
    clearChatConfirm: 'Effacer l\'historique du chat ?',
    weeklyRecap: 'R\u00e9cap hebdomadaire',
    progressAnalyzer: 'Analyse des progr\u00e8s',
    chat: 'Chat',
  },
};
